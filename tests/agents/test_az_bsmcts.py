...
@pytest.fixture
def net(game: pyspiel.Game) -> nets.TinyPolicyValueNet:
    """Create a small network for testing."""
    obs_size = game.observation_tensor_size()
    num_actions = game.num_distinct_actions()
    network = nets.TinyPolicyValueNet(
...
@pytest.fixture
def sampler(game: pyspiel.Game) -> samplers.ParticleDeterminizationSampler:
...
class TestBSMCTSAgent:
    ...
    def test_select_action_returns_legal(self, game: pyspiel.Game) -> None:
